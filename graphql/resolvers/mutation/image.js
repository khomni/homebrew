module.exports = (root, args, context) => {
  ...
  // 4. create image document / upload the image to cloud hosting service / associate it with resource
  // 5. return the image so the client can update the imageable resource
